    ...
    <div className=" py-24 sm:py-32">
      <div className=" mx-auto max-w-8xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl sm:text-center">
          <h2 className="font-league font-bold text-6xl md:text-6xl xl:text-6xl text-white   tracking-normal mb-12">
            alpha hub
          </h2>
          <p className="font-spacegrotesk mt-6 text-xl sm:text-2xl leading-8 text-white">
            access exclusive benefits by holding 2000 $ABC and play an important
            role in the gamification of making calls.
          </p>
        </div>
        <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
          <div className="p-8 sm:p-10 lg:flex-auto">
            ...
            <p className="font-spacegrotesk mt-6 text-xl leading-7 text-white">
              ...
              access premium benefits tailored to your trading needs.
            </p>
            ...
            >
              {includedFeatures.map((feature) => (
                <li
                  key={feature}
                  className="flex gap-x-3 text-xl text-white font-spacegrotesk lowercase"
                >
                  <CheckIcon
