...
var ButtonBase = (0, import_react7.forwardRef)(({ children, as: Component = "button", href, ...props }, ref) => {
  const BaseComponent = href ? "a" : Component != null ? Component : "button";
...
var Image = ({ theme: customTheme = {}, ...props }) => {
  ...
  if (props.imgSrc) {
    return (0, import_jsx_runtime14.jsx)("img", { "data-testid": "flowbite-card-image", alt: (_b = props.imgAlt) != null ? _b : "", src: props.imgSrc, className: twMerge(theme2.img.base, theme2.img.horizontal[props.horizontal ? "on" : "off"]) });
  }
  return null;
};
...
function FloatingFocusManager(props) {
  ...
  index2(() => {
    ...
    return () => {
      ...
      if (returnFocusRef.current && isHTMLElement2(previouslyFocusedElementRef.current) && !preventReturnFocusRef.current) {
...
function useFloating2(options) {
  ...
  const setReference = React4.useCallback((node) => {
    ...
    if (isElement2(position.refs.reference.current) || position.refs.reference.current === null || node !== null && !isElement2(node)) {
...
var FooterCopyright = ({ by, className, href, theme: customTheme = {}, year, ...props }) => {
  ...
  return (0, import_jsx_runtime26.jsxs)("div", { "data-testid": "flowbite-footer-copyright", className: twMerge(theme2.base, className), ...props, children: ["\xA9 ", year, href ? (0, import_jsx_runtime26.jsx)("a", { href, className: theme2.href, children: by }) : (0, import_jsx_runtime26.jsx)("span", { "data-testid": "flowbite-footer-copyright-span", className: theme2.span, children: by })] });
};
...
var HelperText = ({ children, className, color = "default", theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime33.jsx)("p", { className: twMerge(theme2.root.base, theme2.root.colors[color], className), ...props, children: (_a = value != null ? value : children) != null ? _a : "" });
};
...
var Label = ({ children, className, color = "default", disabled = false, theme: customTheme = {}, value, ...props }) => {
  ...
  return (0, import_jsx_runtime34.jsx)("label", { className: twMerge(theme2.root.base, theme2.root.colors[color], disabled && theme2.root.disabled, className), "data-testid": "flowbite-label", ...props, children: (_a = value != null ? value : children) != null ? _a : "" });
};
